...
call py decodeLatticeZ.py single_note    ./afterClean/beta_vae_Banjo_AB        train_set_beta_vae
call py decodeLatticeZ.py single_note_GU ./afterClean/beta_vae_Banjo_AB         test_set_beta_vae
pause
